...
import BaseRelationManager from './Base/RelationManager.vue'

const registry = inject(InvueRegistryKey, null)

const resolved = computed(() => registry?.resolve('panels.RelationManager', BaseRelationManager) ?? BaseRelationManager)
</script>
